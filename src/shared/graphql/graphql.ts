...
export type MyRecommendationsQuery = { __typename?: 'Query', profile?: { __typename?: 'User', recommendations: Array<{ __typename?: 'Recommendation', id: string, title: string, description: string, favoritesCount: number, type: RecommendationType, link?: string | null, created_at: any, comments: Array<{ __typename?: 'Comment', id: string }>, images: Array<{ __typename?: 'Image', id: string, url: string }> }> } | null };

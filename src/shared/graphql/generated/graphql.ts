...
export type Query = {
  ...
  last_recommendations: Array<Recommendation>;
  one_user: User;
  profile: User;
...
export type Create_CommentMutation = { __typename?: 'Mutation', create_comment: { __typename?: 'MessageResponse', message: string } };
